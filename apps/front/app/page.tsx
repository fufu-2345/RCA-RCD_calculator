...
function Page() {
  ...
  const [precis, setPrecis] = useState<number>(5);
  ...
  return (
    <div>
      ...
      <br />
      precis:{" "}
      <input type="number" value={precis} onChange={handleChangePrecis} />
      <br />
      <br />
      {Array.from({ length: size }, (_, i) => (
        <span
          key={i}
          className="bg-white border-black border-[1px] text-center p-[1em] my-[10px]"
        >
          <select
            value={nation[i]}
            onChange={(e) => {
